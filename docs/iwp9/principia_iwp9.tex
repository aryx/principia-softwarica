...
% Plan9 was innovative, elegant, small, designed by great minds. Not just kernel,
% they rethink the whole operating system, network and graphics stack but
% also windowing system, compiling toolchain, debuggers,
% build system. A holistic redesign.
...
%   ARM, and raspeberri pi focus. Greak work by Richard Miller.
...
%   Actually simpplified the code a bit sometimes, so easier to explain!
