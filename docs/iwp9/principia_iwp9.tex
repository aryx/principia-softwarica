...
(with assemblers, linkers, C compilers, debuggers, and profilers for most architectures),
...
the Bash shell, the GNU C library, gcc, gdb, binutils) contains 
...
% ARM focus. simpler than 86, and goal is understand essence,
% not useless detail. But still real arch! not toy arch!
% ARM in most phones today and in raspberry pi!
% in fact kernel 9pi. Great work by Richard Miller.
