...
/*s: constant [[RemoveExtraRelDotDots]](webfs) */
#define RemoveExtraRelDotDots   0
/*e: constant [[RemoveExtraRelDotDots]](webfs) */
/*s: constant [[ExpandCurrentDocUrls]](webfs) */
...
#define PUNCT                   "\\-_.!~*'()"
/*e: constant [[PUNCT]](webfs) */
/*s: constant [[RES]](webfs) */
#define RES                     ";/?:@&=+$,"
/*e: constant [[RES]](webfs) */
/*s: constant [[ALNUM]](webfs) */
#define ALNUM           "a-zA-Z0-9"
/*e: constant [[ALNUM]](webfs) */
/*s: constant [[HEX]](webfs) */
#define HEX                     "0-9a-fA-F"
/*e: constant [[HEX]](webfs) */
/*s: constant [[UNRES]](webfs) */
#define UNRES                   ALNUM PUNCT
/*e: constant [[UNRES]](webfs) */

/* RE components; _N => has N parenthesized subexpressions when expanded */
/*s: constant [[ESCAPED_1]](webfs) */
#define ESCAPED_1                       "(%[" HEX "][" HEX "])"
/*e: constant [[ESCAPED_1]](webfs) */
/*s: constant [[URIC_2]](webfs) */
#define URIC_2                  "([" RES UNRES "]|" ESCAPED_1 ")"
/*e: constant [[URIC_2]](webfs) */
/*s: constant [[URICNOSLASH_2]](webfs) */
#define URICNOSLASH_2           "([" UNRES ";?:@&=+$,]|" ESCAPED_1 ")"
/*e: constant [[URICNOSLASH_2]](webfs) */
/*s: constant [[USERINFO_2]](webfs) */
#define USERINFO_2              "([" UNRES ";:&=+$,]|" ESCAPED_1 ")"
/*e: constant [[USERINFO_2]](webfs) */
/*s: constant [[PCHAR_2]](webfs) */
#define PCHAR_2                 "([" UNRES ":@&=+$,]|" ESCAPED_1 ")"
/*e: constant [[PCHAR_2]](webfs) */
/*s: constant [[PSEGCHAR_3]](webfs) */
...
/*e: function [[countleftparen]](webfs) */

/*s: function [[initurl]](webfs) */
void
initurl(void)
{
    int i, j;
...
/*e: function [[merge_relative_path]](webfs) */

/*s: function [[resolve_relative]](webfs) */
/*
...
/*e: function [[resolve_relative]](webfs) */

/*s: function [[regx]](webfs) */
int
...
/*e: function [[regx]](webfs) */

/*s: function [[ismatch]](webfs) */
static int
...
/*e: function [[ismatch]](webfs) */

/*s: function [[spliturl]](webfs) */
static int
...
/*e: function [[spliturl]](webfs) */

/*s: function [[parse_scheme]](webfs) */
static int
...
/*e: function [[parse_scheme]](webfs) */

/*s: function [[parse_unknown_part]](webfs) */
static int
...
/*e: function [[parse_unknown_part]](webfs) */

/*s: function [[parse_userinfo]](webfs) */
static int
...
/*e: function [[parse_userinfo]](webfs) */

/*s: function [[parse_host]](webfs) */
static int
...
/*e: function [[parse_host]](webfs) */

/*s: function [[parse_authority]](webfs) */
static int
...
/*e: function [[parse_authority]](webfs) */

/*s: function [[parse_abspath]](webfs) */
static int
...
/*e: function [[parse_abspath]](webfs) */

/*s: function [[parse_query]](webfs) */
static int
...
/*e: function [[parse_query]](webfs) */

/*s: function [[parse_fragment]](webfs) */
static int
...
/*e: function [[parse_fragment]](webfs) */

/*s: function [[postparse_http]](webfs) */
static int
...
/*e: function [[postparse_http]](webfs) */

/*s: function [[postparse_ftp]](webfs) */
static int
postparse_ftp(Url *u)
{
    Resub m[MaxResub];
...
/*e: function [[postparse_ftp]](webfs) */

/*s: function [[postparse_file]](webfs) */
static int
...
/*e: function [[parseurl]](webfs) */

/*s: function [[freeurl]](webfs) */
void
freeurl(Url *u)
{
    if(u == nil)
...
/*e: function [[freeurl]](webfs) */

/*s: function [[rewriteurl]](webfs) */
void
rewriteurl(Url *u)
{
    char *s;
...
/*e: function [[rewriteurl]](webfs) */

/*s: function [[seturlquery]](webfs) */
int
...
/*e: function [[seturlquery]](webfs) */

/*s: function [[dupp]](webfs) */
static void
dupp(char **p)
{
    if(*p)
...
/*e: function [[dupp]](webfs) */

/*s: function [[copyurl]](webfs) */
Url*
copyurl(Url *u)
{
    Url *v;
...
/*e: function [[copyurl]](webfs) */

/*s: function [[dhex]](webfs) */
static int
dhex(char c)
{
    if('0' <= c && c <= '9')
...
/*e: function [[dhex]](webfs) */

/*s: function [[escapeurl]](webfs) */
char*
...
/*e: function [[escapeurl]](webfs) */

/*s: function [[unescapeurl]](webfs) */
char*
unescapeurl(char *s)
{
    char *r, *w;
