...
/*e: constant TEXT_LEN */
/*s: constant MAX_PORTS */
#define MAX_PORTS	32
/*e: constant MAX_PORTS */
/*s: constant SEGMENT_LEN */
#define SEGMENT_LEN	32768
/*e: constant SEGMENT_LEN */
...
/*s: function special_value_p */
#define special_value_p(x)	((x) < 0)
/*e: function special_value_p */
/*s: constant NIL */
#define NIL		(-1)
/*e: constant NIL */
/*s: constant TRUE */
...
#define FALSE		(-3)
/*e: constant FALSE */
/*s: constant ENDOFFILE */
#define ENDOFFILE	(-4)
/*e: constant ENDOFFILE */
/*s: constant UNDEFINED */
#define UNDEFINED	(-5)
/*e: constant UNDEFINED */
/*s: constant UNSPECIFIC */
#define UNSPECIFIC	(-6)
/*e: constant UNSPECIFIC */
/*s: constant DOT */
#define	DOT		(-7)
/*e: constant DOT */
/*s: constant RPAREN */
...
/*e: function eof_p */
/*s: function undefined_p */
#define undefined_p(n)	((n) == UNDEFINED)
/*e: function undefined_p */
/*s: function unspecific_p */
#define unspecific_p(n)	((n) == UNSPECIFIC)
/*e: function unspecific_p */

/*s: function boolean_p */
#define boolean_p(n)	((n) == TRUE || (n) == FALSE)
/*e: function boolean_p */

/*s: function integer_p */
#define integer_p(n) \
    (!special_value_p(n) && (Tag[n] & AFLAG) && Car[n] == S_integer)
/*e: function integer_p */
/*s: function primitive_p */
#define primitive_p(n) \
    (!special_value_p(n) && (Tag[n] & AFLAG) && Car[n] == S_primitive)
/*e: function primitive_p */
/*s: function procedure_p */
#define procedure_p(n) \
    (!special_value_p(n) && (Tag[n] & AFLAG) && Car[n] == S_procedure)
/*e: function procedure_p */
/*s: function special_p */
...
#define auto_quoting_p(n) \
    (boolean_p(n)    || \
     ...
     unspecific_p(n) || \
     vector_p(n))
/*e: function auto_quoting_p */

/*s: function rib_args */
#define rib_args(x)	(Car[x])
/*e: function rib_args */
/*s: function rib_append */
#define rib_append(x)	(cadr(x))
/*e: function rib_append */
/*s: function rib_result */
#define rib_result(x)	(caddr(x))
/*e: function rib_result */
/*s: function rib_source */
#define rib_source(x)	(cadddr(x))
/*e: function rib_source */
...
/*e: function find_symbol */

/*s: function make_symbol */
...
/*e: function make_symbol */

/*s: function add_symbol */
...
/*e: function str_numeric_p */

/*s: function string_to_bignum */
...
/*e: function string_to_bignum */

/*s: function make_char */
...
/*e: function character */

/*s: function make_string */
...
/*e: function make_string */

/*s: function clone_string */
...
/*e: function clone_string */

/*s: function string_literal */
...
/*e: function string_literal */

/*s: function unreadable */
...
/*e: function unreadable */

/*s: function separator */
#define separator(c) \
    ((c) == ' '  || (c) == '\t' || (c) == '\n' || \
     (c) == '\r' || (c) == '('  || (c) == ')'  || \
     (c) == ';'  || (c) == '#'  || (c) == '\'' || \
     (c) == '`'  || (c) == ','  || (c) == '"'  || \
     (c) == EOF)
/*e: function separator */

/*s: function symbol_or_number */
...
/*e: function symbol_or_number */

/*s: function nested_comment */
...
/*e: function nested_comment */

/*s: function list_to_vector */
...
/*e: function list_to_vector */

/*s: function read_vector */
...
/*e: function read_vector */

/*s: function read_form */
int read_form(void) {
    int	c, c2;
...
/*e: function print_quoted */

/*s: function print_procedure */
...
/*e: function print_procedure */

/*s: function print_char */
...
/*e: function print_char */

/*s: function print_string */
...
/*e: function print_string */

/*s: function print_symbol */
...
/*e: function print_symbol */

/*s: function print_primitive */
...
/*e: function print_primitive */

/*s: function print_syntax */
int print_syntax(int n) {
    if (Car[n] != S_syntax) return 0;
    pr("#<syntax>");
    return -1;
}
/*e: function print_syntax */

/*s: function print_vector */
...
/*e: function print_vector */

/*s: function print_port */
...
/*e: function flat_copy */

/*s: function argument_list_p */
...
/*e: function argument_list_p */

/*s: function list_of_symbols_p */
int list_of_symbols_p(int n) {
    return !symbol_p(n) && argument_list_p(n);
}
/*e: function list_of_symbols_p */
...
/*e: function too_few_args */

/*s: function too_many_args */
int too_many_args(int n) {
    return error("too many arguments", n);
}
/*e: function too_many_args */

/*s: function make_sequence */
...
/*e: function make_temporaries */

/*s: function make_assignments */
...
/*e: function make_assignments */

/*s: function make_undefineds */
...
/*e: function make_undefineds */

/*s: function make_recursive_lambda */
/* Returns ((lambda (v0 ...)
 *            ((lambda (t0 ...)
 *               (begin (set! v0 t0)
 *                      ...
...
/*e: function make_recursive_lambda */
...
/*e: function extract_from_let */

/*s: function extract_from_defines */
...
/*e: function extract_from_defines */

/*s: function resolve_local_defines */
...
/*e: function resolve_local_defines */

/*s: function sf_lambda */
int sf_lambda(int x) {
    int	n, k;
...
/*s: function find_local_variable */
...
/*e: function find_local_variable */

/*s: function sf_define */
...
/*e: function sf_define */

/*s: function sf_define_syntax */
...
/*e: function sf_define_syntax */

/*s: function sf_syntax_rules */
...
/*e: function make_integer */

/*s: function integer_value */
...
/*e: function integer_value */

/*s: function bignum_abs */
...
/*e: function bignum_abs */

/*s: function bignum_negate */
...
/*e: function bignum_negate */

/*s: function bignum_negative_p */
#define bignum_negative_p(a) ((cadr(a)) < 0)
/*e: function bignum_negative_p */

/*s: function bignum_zero_p */
#define bignum_zero_p(a) ((cadr(a) == 0) && (cddr(a)) == NIL)
/*e: function bignum_zero_p */

/*s: function reverse_segments */
...
/*e: function _bignum_add */

/*s: function bignum_add */
int bignum_add(int a, int b) {
    Tmp = b;
    save(a);
    save(b);
...
/*e: function bignum_add */

/*s: function bignum_less_p */
...
/*e: function bignum_less_p */

/*s: function bignum_equal_p */
...
/*e: function bignum_equal_p */

/*s: function _bignum_subtract */
...
/*e: function _bignum_subtract */

/*s: function bignum_subtract */
int bignum_subtract(int a, int b) {
    Tmp = b;
    save(a);
    save(b);
...
/*e: function bignum_subtract */

/*s: function bignum_shift_left */
...
/*e: function bignum_shift_left */

/*s: function bignum_shift_right */
/* Result: (a/10 . a%10) */
...
/*e: function bignum_shift_right */

/*s: function bignum_multiply */
...
/*e: function bignum_multiply */

/*s: function bignum_equalize */
...
/*e: function bignum_equalize */

/*s: function _bignum_divide */
/* Result: (a/b . a%b) */
...
/*e: function _bignum_divide */

/*s: function bignum_divide */
...
/*e: function pp_char_whitespace_p */

/*s: function close_port */
...
/*e: function close_port */

/*s: function pp_close_input_port */
...
/*e: function pp_close_input_port */

/*s: function pp_close_output_port */
...
/*e: function pp_close_output_port */
...
/*e: function make_port */

/*s: function pp_current_input_port */
int pp_current_input_port(int x) {
    return make_port(Input_port, S_input_port);
}
/*e: function pp_current_input_port */

/*s: function pp_current_output_port */
...
/*e: function pp_display */

/*s: function pp_eof_object_p */
int pp_eof_object_p(int x) {
    return cadr(x) == ENDOFFILE? TRUE: FALSE;
}
/*e: function pp_eof_object_p */
...
/*e: function pp_greater */

/*s: function pp_greater_equal */
...
/*e: function pp_greater_equal */

/*s: function pp_input_port_p */
int pp_input_port_p(int x) {
    return input_port_p(cadr(x))? TRUE: FALSE;
}
/*e: function pp_input_port_p */

/*s: function pp_integer_to_char */
...
/*e: function pp_integer_to_char */

/*s: function pp_integer_p */
int pp_integer_p(int x) {
    return integer_p(cadr(x))? TRUE: FALSE;
}
/*e: function pp_integer_p */
...
/*e: function pp_less_equal */

/*s: function pp_list_to_string */
...
/*e: function pp_list_to_string */

/*s: function pp_list_to_vector */
int pp_list_to_vector(int x) {
    return list_to_vector(cadr(x), "improper list in list->vector");
}
/*e: function pp_list_to_vector */

/*s: function open_port */
...
/*e: function pp_make_string */

/*s: function pp_make_vector */
...
/*e: function pp_open_input_file */

/*s: function pp_open_output_file */
...
/*e: function pp_open_output_file */

/*s: function pp_output_port_p */
int pp_output_port_p(int x) {
    return output_port_p(cadr(x))? TRUE: FALSE;
}
/*e: function pp_output_port_p */

/*s: function pp_pair_p */
int pp_pair_p(int x) {
    return atom_p(cadr(x))? FALSE: TRUE;
}
/*e: function pp_pair_p */
...
/*e: function read_char */

/*s: function pp_peek_char */
int pp_peek_char(int x) {
    return read_char(x, 1);
}
/*e: function pp_peek_char */

/*s: function pp_read_char */
int pp_read_char(int x) {
    return read_char(x, 0);
}
/*e: function pp_read_char */

/*s: function pp_remainder */
int pp_remainder(int x) {
    return Cdr[bignum_divide(x, cadr(x), caddr(x))];
}
/*e: function pp_remainder */

/*s: function pp_set_car_b */
int pp_set_car_b(int x) {
    caadr(x) = caddr(x);
    return UNSPECIFIC;
}
/*e: function pp_set_car_b */

/*s: function pp_set_cdr_b */
int pp_set_cdr_b(int x) {
    cdadr(x) = caddr(x);
    return UNSPECIFIC;
}
/*e: function pp_set_cdr_b */

/*s: function pp_set_input_port_b */
int pp_set_input_port_b(int x) {
    Input_port = port_no(cadr(x));
    return UNSPECIFIC;
}
/*e: function pp_set_input_port_b */

/*s: function pp_set_output_port_b */
int pp_set_output_port_b(int x) {
    Output_port = port_no(cadr(x));
    return UNSPECIFIC;
}
/*e: function pp_set_output_port_b */

/*s: function pp_string_to_list */
...
/*e: function pp_string_to_list */

/*s: function pp_string_to_symbol */
...
/*e: function pp_string_to_symbol */


/*s: function pp_string_append */
...
/*e: function pp_string_append */

/*s: function pp_string_copy */
int pp_string_copy(int x) {
    return clone_string(cadr(x), string_len(cadr(x))-1);
}
/*e: function pp_string_copy */

/*s: function pp_string_fill_b */
...
/*e: function pp_string_fill_b */

/*s: function pp_substring */
...
/*e: function pp_substring */

/*s: function pp_string_length */
int pp_string_length(int x) {
    return make_integer(string_len(cadr(x))-1);
}
/*e: function pp_string_length */

/*s: function pp_string_ref */
...
/*e: function pp_string_ref */

/*s: function pp_string_set_b */
...
/*e: function pp_string_set_b */

/*s: function strcmp_ci */
...
/*e: function pp_vector_to_list */

/*s: function pp_vector_fill_b */
...
/*e: function pp_vector_fill_b */

/*s: function pp_vector_length */
int pp_vector_length(int x) {
    return make_integer(vector_len(cadr(x)));
}
/*e: function pp_vector_length */

/*s: function pp_vector_ref */
...
/*e: function pp_vector_ref */

/*s: function pp_vector_set_b */
...
/*e: function pp_vector_set_b */

/*s: function pp_vector_p */
int pp_vector_p(int x) {
    return vector_p(cadr(x))? TRUE: FALSE;
}
/*e: function pp_vector_p */
...
/*s: function pp_write_char */
int pp_write_char(int x) {
    return pp_display(x);
}
/*e: function pp_write_char */
...
/*e: function primitive */

/*s: function make_application */
...
/*e: function make_application */

/*s: function has_property_p */
...
/*e: function has_property_p */

/*s: function syntactic_symbol_p */
...
/*e: function syntactic_symbol_p */

/*s: function quasiquotation_p */
int quasiquotation_p(int x) {
    return Car[x] == S_quasiquote;
}
/*e: function quasiquotation_p */

/*s: function uses_transformer_p */
int uses_transformer_p(int x) {
    return has_property_p(syntactic_symbol_p, x);
}
/*e: function uses_transformer_p */

/*s: function uses_quasiquote_p */
...
/*e: function expand_qq */

/*s: function expand_quasiquote */
...
/*e: function expand_quasiquote */

/*s: function expand_all_syntax */
...
/*e: function expand_all_syntax */

/*s: function expand_syntax */
...
/*e: function expand_syntax */

/*s: function save_state */
#define save_state(v) (State_stack = alloc3((v), State_stack, AFLAG))
/*e: function save_state */

/*s: function restore_state */
...
/*e: function restore_state */

/*s: function bind_arguments */
...
/*e: function bind_arguments */

/*s: function tail_call */
void tail_call(void) {
...
/*e: function tail_call */

/*s: function apply_special */
...
/*e: function apply_special */

/*s: function make_dynamic */
void make_dynamic(int x) {
    if (procedure_p(x))
        cdddr(x) = NIL; /* clear lexical env. */
}
/*e: function make_dynamic */
...
/*e: function make_primitive */

/*s: function add_primitive */
...
/*e: function add_primitive */

/*s: function make_initial_env */
