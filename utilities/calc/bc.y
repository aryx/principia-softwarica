...
%{
        ...
        /*e: prelude bc.y */
%}
/*s: union directive bc.y */
%union
{
        char*   cptr;
        int     cc;
}
/*e: union directive bc.y */
...
%token  <cc>    QSTR ERROR
/*e: token directives bc.y */
/*s: priority directives bc.y */
%right  '=' EQOP
%left   '+' '-'
%left   '*' '/' '%'
%right  '^'
%left   UMINUS
/*e: priority directives bc.y */
%%
/*s: grammar bc.y */
start:
        start stuff
...
main(int argc, char **argv)
{
        ...
        while(argc > 1 && *argv[1] == '-') {
                ...
                case 's':
                        ...
                        break;
                default:
                        fprint(STDERR, "Usage: bc [-cdls] [file ...]\n");
                        exits("usage");
                }
                argc--;
                argv++;
