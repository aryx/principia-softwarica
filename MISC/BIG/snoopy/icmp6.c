/*s: networking/ip/snoopy/icmp6.c */
#include <u.h>
#include <libc.h>
#include <ip.h>
#include "dat.h"
...
/*s: struct [[Hdr]]([[(networking/ip/snoopy/icmp6.c)]]) */
struct Hdr
{	uchar	type;
    uchar	code;
...
/*e: struct [[Hdr]]([[(networking/ip/snoopy/icmp6.c)]]) */

/*s: enum [[_anon_ (networking/ip/snoopy/icmp6.c)]] */
enum
{
    ICMP6LEN=	4,
};
/*e: enum [[_anon_ (networking/ip/snoopy/icmp6.c)]] */

/*s: enum [[_anon_ (networking/ip/snoopy/icmp6.c)2]] */
enum
{
    Ot,	/* type */
    Op,	/* next protocol */
};
/*e: enum [[_anon_ (networking/ip/snoopy/icmp6.c)2]] */

/*s: global [[p_fields]]([[(networking/ip/snoopy/icmp6.c)]]) */
static Field p_fields[] =
{
    {"t",		Fnum,	Ot,	"type",	} ,
    {0}
};
/*e: global [[p_fields]]([[(networking/ip/snoopy/icmp6.c)]]) */

/*s: enum [[_anon_ (networking/ip/snoopy/icmp6.c)3]] */
enum
{
    /* ICMPv6 types */
    EchoReply	= 0,
...
/*e: enum [[_anon_ (networking/ip/snoopy/icmp6.c)3]] */

/*s: global [[p_mux]]([[(networking/ip/snoopy/icmp6.c)]]) */
static Mux p_mux[] =
{
    {"ip6",	UnreachableV6, },
    {"ip6",	RedirectV6, },
...
/*e: global [[p_mux]]([[(networking/ip/snoopy/icmp6.c)]]) */
...
/*s: global [[unreachcode]]([[(networking/ip/snoopy/icmp6.c)]]) */
...
/*e: global [[unreachcode]]([[(networking/ip/snoopy/icmp6.c)]]) */
...
/*e: global [[parpcode]] */
/*s: enum [[_anon_ (networking/ip/snoopy/icmp6.c)4]] */
enum
{
    sll	= 1,
    tll	= 2,
...
/*e: enum [[_anon_ (networking/ip/snoopy/icmp6.c)4]] */
...
/*s: function [[p_compile]]([[(networking/ip/snoopy/icmp6.c)]]) */
static void
p_compile(Filter *f)
{
    if(f->op == '='){
...
/*e: function [[p_compile]]([[(networking/ip/snoopy/icmp6.c)]]) */

/*s: function [[p_filter]]([[(networking/ip/snoopy/icmp6.c)]]) */
static int
...
/*e: function [[p_filter]]([[(networking/ip/snoopy/icmp6.c)]]) */

/*s: function [[opt_seprint]] */
static char*
opt_seprint(Msg *m)
{
    int otype, osz, pktsz;
...
/*e: function [[opt_seprint]] */

/*s: function [[p_seprint]]([[(networking/ip/snoopy/icmp6.c)]]) */
static int
p_seprint(Msg *m)
{
    int i;
...
/*e: function [[p_seprint]]([[(networking/ip/snoopy/icmp6.c)]]) */
...
/*e: global [[icmp6]] */
/*e: networking/ip/snoopy/icmp6.c */
