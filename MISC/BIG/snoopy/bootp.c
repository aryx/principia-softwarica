/*s: networking/ip/snoopy/bootp.c */
#include <u.h>
#include <libc.h>
#include <ip.h>
#include "dat.h"
...
/*s: enum [[_anon_ (networking/ip/snoopy/bootp.c)]] */
enum
{
...
/*e: enum [[_anon_ (networking/ip/snoopy/bootp.c)]] */

typedef struct Hdr	Hdr;
/*s: struct [[Hdr]]([[(networking/ip/snoopy/bootp.c)]]) */
struct Hdr
{
    uchar	op;			/* opcode */
...
/*e: struct [[Hdr]]([[(networking/ip/snoopy/bootp.c)]]) */

/*s: enum [[_anon_ (networking/ip/snoopy/bootp.c)2]] */
enum
{
    Oca,
    Osa,
...
/*e: enum [[_anon_ (networking/ip/snoopy/bootp.c)2]] */

/*s: global [[p_fields]]([[(networking/ip/snoopy/bootp.c)]]) */
...
/*e: global [[p_fields]]([[(networking/ip/snoopy/bootp.c)]]) */

/*s: constant [[plan9opt]] */
#define plan9opt ((ulong)(('p'<<24) | ('9'<<16) | (' '<<8) | ' '))
/*e: constant [[plan9opt]] */
/*s: constant [[genericopt]] */
#define genericopt (0x63825363UL)
/*e: constant [[genericopt]] */

/*s: global [[p_mux]]([[(networking/ip/snoopy/bootp.c)]]) */
static Mux p_mux[] =
{
    {"dhcp", 	genericopt,},
    {"plan9bootp",	plan9opt,},
...
/*e: global [[p_mux]]([[(networking/ip/snoopy/bootp.c)]]) */

/*s: function [[p_compile]]([[(networking/ip/snoopy/bootp.c)]]) */
static void
p_compile(Filter *f)
{
    Mux *m;
...
/*e: function [[p_compile]]([[(networking/ip/snoopy/bootp.c)]]) */

/*s: function [[p_filter]]([[(networking/ip/snoopy/bootp.c)]]) */
static int
...
/*e: function [[p_filter]]([[(networking/ip/snoopy/bootp.c)]]) */
...
/*s: function [[p_seprint]]([[(networking/ip/snoopy/bootp.c)]]) */
static int
p_seprint(Msg *m)
{
    Hdr *h;
...
/*e: function [[p_seprint]]([[(networking/ip/snoopy/bootp.c)]]) */
...
/*e: global [[bootp]] */
/*e: networking/ip/snoopy/bootp.c */
