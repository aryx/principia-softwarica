...
static void
fld(void (*f)(Internal*, void*), int d, ulong ea, int n, Arch_FPsave *ufp)
{
	void *mem;
...
static void
fst(void (*f)(void*, Internal*), ulong ea, int s, int n, Arch_FPsave *ufp)
{
	Internal tmp;
	void *mem;
...
static void
fpemu(ulong pc, ulong op, Ureg *ur, Arch_FPsave *ufp)
{
	int rn, rd, tag, o;
	long off;
	ulong ea;
