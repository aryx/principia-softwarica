...
/*e: function error (windows/apps/screenlock.c) */

/*s: function usage (windows/apps/screenlock.c) */
static void
usage(void)
{
    fprint(2, "usage: %s\n", argv0);
...
/*e: function threadmain (windows/apps/screenlock.c) */
/*e: windows/apps/screenlock.c */
