...
/*s: function allprint (generators/lex/sub1.c) */
void
allprint(int c)
{
    if(c < 0)
...
/*e: function allprint (generators/lex/sub1.c) */
...
/*e: function sect1dump */

/*s: function sect2dump */
void
sect2dump(void)
{
    print("Sect 2:\n");
