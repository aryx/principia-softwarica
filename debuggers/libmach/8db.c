...
/*e: struct [[Instr]](x86) */
    ...
    /* 386 register (ha!) set */
/*s: enum _anon_ (libmach/8db.c)(x86) */
enum{
    AX=0,
    CX,
    DX,
...
/*e: enum _anon_ (libmach/8db.c)(x86) */

    /* amd64 rex extension byte */
/*s: enum _anon_ (libmach/8db.c)2(x86) */
enum{
...
/*e: enum _anon_ (libmach/8db.c)2(x86) */
...
/*s: enum _anon_ (libmach/8db.c)3(x86) */
enum {
...
/*e: enum _anon_ (libmach/8db.c)3(x86) */
...
/*s: global reg (libmach/8db.c)(x86) */
static char *reg[] =  {
[AX]	"AX",
[CX]	"CX",
[DX]	"DX",
...
/*e: global reg (libmach/8db.c)(x86) */
