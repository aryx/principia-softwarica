...
to Unix (see [Wikipedia](https://en.wikipedia.org/wiki/Plan_9_from_Bell_Labs)).
...
It does not contain all the programs of the original Plan 9;
...
As opposed to the original Plan 9, this fork can also be
