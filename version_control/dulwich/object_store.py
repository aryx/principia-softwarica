...
INFODIR = 'info'
# nw_s: constant object_store.PACKDIR |f3ac0ca2d2f7284e4c0bf36356149daf#
PACKDIR = 'pack'
# nw_e: constant object_store.PACKDIR #

# nw_s: class BaseObjectStore |9a937ee875c2363767aa33debb2af472#
class BaseObjectStore(object):
    """Object store interface."""

    # nw_s: [[BaseObjectStore]] methods |506949cf1da82e67881cf99f0831e948#
    def __getitem__(self, sha):
        """Obtain an object by SHA1."""
        type_num, uncomp = self.get_raw(sha)
        return ShaFile.from_raw_string(type_num, uncomp, sha=sha)
    # nw_e: [[BaseObjectStore]] methods #
    # nw_s: [[BaseObjectStore]] methods |a6fad78194db240e72842af5a8d11113#
    ...
    # nw_e: [[BaseObjectStore]] methods #
    # nw_s: [[BaseObjectStore]] methods |3e0bebba467b76521f44ad2a9940642a#
    def contains_packed(self, sha):
        """Check if a particular object is present by SHA1 and is packed."""
        raise NotImplementedError(self.contains_packed)

    # nw_e: [[BaseObjectStore]] methods #
    # nw_s: [[BaseObjectStore]] methods |e25a91bd155255c7de25879546fa868f#
...
class PackBasedObjectStore(BaseObjectStore):
    ...
    def get_raw(self, name):
        ...
        # nw_s: [[PackBasedObjectStore.get_raw()]] look in packs |acbc55f5a4842b69d51d61e0749e966a#
        for pack in self.packs:
            try:
                return pack.get_raw(sha)
            except KeyError:
                pass
        # nw_e: [[PackBasedObjectStore.get_raw()]] look in packs #
        if hexsha is None:
        ...
        # nw_s: [[PackBasedObjectStore.get_raw()]] look in alternates |1747a0949af0da0c0080789fd633fe11#
    ...
    # nw_e: [[PackBasedObjectStore]] methods #
    # nw_s: [[PackBasedObjectStore]] methods |6b434c1200a154d32b8da34cf6928795#
    def __contains__(self, sha):
        """Check if a particular object is present by SHA1.
    ...
    # nw_e: [[PackBasedObjectStore]] methods #
    # nw_s: [[PackBasedObjectStore]] methods |83eef8e4eaa78007d34d2605530f0531#
    def _pack_cache_stale(self):
        """Check whether the pack cache is stale."""
        raise NotImplementedError(self._pack_cache_stale)

    # nw_e: [[PackBasedObjectStore]] methods #
    # nw_s: [[PackBasedObjectStore]] methods |0e5e2de5434cc16defa93151d4f98f72#
    ...
    # nw_e: [[PackBasedObjectStore]] methods #
    # nw_s: [[PackBasedObjectStore]] methods |6109e487d35605c56ca4777e70b0c0bc#
    def close(self):
    ...
    # nw_e: [[PackBasedObjectStore]] methods #
    # nw_s: [[PackBasedObjectStore]] methods |e621d4886184fdc432af782dd2f0e248#
    @property
    def packs(self):
    ...
    # nw_e: [[PackBasedObjectStore]] methods #
    # nw_s: [[PackBasedObjectStore]] methods |8539929ff48301b05d5472eaf26951d1#
    ...
    # nw_e: [[PackBasedObjectStore]] methods #
    # nw_s: [[PackBasedObjectStore]] methods |1049de82824dd8beafde9c9ce5a136be#
    def __iter__(self):
        """Iterate over the SHAs that are present in this store."""
    ...
    def __init__(self):
        self._pack_cache = {}
    # nw_e: [[PackBasedObjectStore]] methods #
    # nw_s: [[PackBasedObjectStore]] methods |44fcbb097ffa8c025ed251061837117e#
    @property
    def alternates(self):
        return []

    # nw_e: [[PackBasedObjectStore]] methods #
# nw_e: class PackBasedObjectStore #

# nw_s: class DiskObjectStore |77346b20fd2da5ea41964a6e15fb2182#
class DiskObjectStore(PackBasedObjectStore):
    """Git-style object store that exists on disk."""

    # nw_s: [[DiskObjectStore]] methods |c66f245b4470ab219c47d61a1e2b73af#
    def __init__(self, path):
        ...
        # nw_s: [[DiskObjectStore.__init__()]] set pack fields |0da5c6a4287eeb96d12a90122a937e95#
        self.pack_dir = os.path.join(self.path, PACKDIR)
        self._pack_cache_time = 0
        self._pack_cache = {}
        # nw_e: [[DiskObjectStore.__init__()]] set pack fields #
        # nw_s: [[DiskObjectStore.__init__()]] set alternates |aac39f5639d1ec9c79afefc4ec10f90f#
        self._alternates = None
        # nw_e: [[DiskObjectStore.__init__()]] set alternates #
    # nw_e: [[DiskObjectStore]] methods #
    # nw_s: [[DiskObjectStore]] methods |2a1a397205a0c510b91c1f1ffdfc4400#
    @classmethod
    def init(cls, path):
        try:
            os.mkdir(path)
        ...
        # nw_s: [[DiskObjectStore.init()]] create pack dir |fe6cef3e1c53c44bc502212906b1e0a4#
        os.mkdir(os.path.join(path, PACKDIR))
        # nw_e: [[DiskObjectStore.init()]] create pack dir #
        return cls(path)

    # nw_e: [[DiskObjectStore]] methods #
    # nw_s: [[DiskObjectStore]] methods |e3bc3096cd2673249bf779daacfae89b#
    def _get_loose_object(self, sha):
        ...
        try:
            ...
            raise
    # nw_e: [[DiskObjectStore]] methods #
    # nw_s: [[DiskObjectStore]] methods |a791323997d0fcfe6b3950ec26aac10a#
    def _get_shafile_path(self, sha):
        # Check from object dir
        return hex_to_filename(self.path, sha)

    # nw_e: [[DiskObjectStore]] methods #
    # nw_s: [[DiskObjectStore]] methods |5e0b49c954edb17424d4c773d070d90f#
    def add_object(self, obj):
        """Add a single object to this object store.
    ...
    # nw_e: [[DiskObjectStore]] methods #
    # nw_s: [[DiskObjectStore]] methods |f01dbad637a75effa8a2f4778233e395#
    def _pack_cache_stale(self):
        try:
    ...
    # nw_e: [[DiskObjectStore]] methods #
    # nw_s: [[DiskObjectStore]] methods |1238e360d9ee5ac5e7b9a1736e5bf687#
    def add_pack(self):
    ...
    # nw_e: [[DiskObjectStore]] methods #
    # nw_s: [[DiskObjectStore]] methods |8b78c11e389a93b8de8df71923e2e3fe#
    ...
    # nw_e: [[DiskObjectStore]] methods #
    # nw_s: [[DiskObjectStore]] methods |3489f1a144d34fb4c04a6d455ce952e5#
    def _complete_thin_pack(self, f, path, copier, indexer):
        ...
        return final_pack
    # nw_e: [[DiskObjectStore]] methods #
    # nw_s: [[DiskObjectStore]] methods |6de9980414c99d6f5aa7eefdae627892#
    @property
    def alternates(self):
    ...
    # nw_e: [[DiskObjectStore]] methods #
    # nw_s: [[DiskObjectStore]] methods |3fe00086b94ae94bd441936bf03e83e9#
    ...
    # nw_e: [[DiskObjectStore]] methods #
    # nw_s: [[DiskObjectStore]] methods |d4a2c6a331ef2343a2db315d6828becf#
    ...
    # nw_e: [[DiskObjectStore]] methods #
    # nw_s: [[DiskObjectStore]] methods |b589df7abe4c437e3bd50a4443d344e1#
    def __repr__(self):
